package gov.pnnl.goss.gridapps.blazegraph.query;
...
import gov.pnnl.goss.gridapps.blazegraph.api.Query;

@Component
public class QueryImpl implements Query {

	private Logger log = Logger.getLogger(QueryImpl.class);

	@Override
	public void sparqlQuery() {}
	
	@Start
	public void initTestStore() throws IOException, OpenRDFException {
		...
		try {
			...
			/*
			 * Load data from resources src/main/resources/data.n3
			 */
	...
	public static Properties loadProperties(final String resource) throws IOException {
		...
		final InputStream is = QueryImpl.class.getResourceAsStream(resource);
	 ...
	 */
	public static TupleQueryResult executeSelectQuery(final Repository repo, final String query, final QueryLanguage ql)
